...
import { Activity, Users, MessageSquare, Zap, TrendingUp, Clock, ArrowUpRight } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-gray-500 mt-0.5">Welcome back! Here's what's happening with your agents.</p>
      </div>
